...
Before proceeding, ensure that you have completed **Chapter 3** of the official [TurtleBot3 Manual](https://emanual.robotis.com/docs/en/platform/turtlebot3/quick-start/) on **both**:
...
2. **Create package shortcut**

   Replace `<TURTLEBOT_NUMBER>` with the appropriate robot ID, and do the following for all the turtlebot numbers to ensure the package can be built successfully.
